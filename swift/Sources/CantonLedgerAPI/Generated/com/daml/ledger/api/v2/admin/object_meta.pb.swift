...
public nonisolated struct Com_Daml_Ledger_Api_V2_Admin_ObjectMeta: Sendable {
...
nonisolated extension Com_Daml_Ledger_Api_V2_Admin_ObjectMeta: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ObjectMeta"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{4}\u{6}resource_version\0\u{2}\u{6}annotations\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 6: try { try decoder.decodeSingularStringField(value: &self.resourceVersion) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.resourceVersion.isEmpty {
      try visitor.visitSingularStringField(value: self.resourceVersion, fieldNumber: 6)
    }
  ...
  public static func ==(lhs: Com_Daml_Ledger_Api_V2_Admin_ObjectMeta, rhs: Com_Daml_Ledger_Api_V2_Admin_ObjectMeta) -> Bool {

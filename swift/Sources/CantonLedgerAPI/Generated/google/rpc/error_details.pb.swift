...
public nonisolated struct Google_Rpc_RetryInfo: Sendable {
  ...
  public var hasRetryDelay: Bool {self._retryDelay != nil}
...
public nonisolated struct Google_Rpc_QuotaFailure: Sendable {
  ...
  public nonisolated struct Violation: Sendable {
    ...
    public var apiService: String = String()
    ...
    public var quotaMetric: String = String()

    /// The id of the violated quota. Also know as "limit name", this is the
    /// unique identifier of a quota in the context of an API service.
    ///
    /// For example, "CPUS-PER-VM-FAMILY-per-project-region".
    public var quotaID: String = String()
    ...
    /// empty.
    public var quotaDimensions: Dictionary<String,String> = [:]
    ...
    public var hasFutureQuotaValue: Bool {self._futureQuotaValue != nil}
    /// Clears the value of `futureQuotaValue`. Subsequent reads from it will return its default value.
    public mutating func clearFutureQuotaValue() {self._futureQuotaValue = nil}
...
public nonisolated struct Google_Rpc_BadRequest: Sendable {
  ...
  public nonisolated struct FieldViolation: Sendable {
    ...
    public var localizedMessage: Google_Rpc_LocalizedMessage {
    ...
    public var hasLocalizedMessage: Bool {self._localizedMessage != nil}
    /// Clears the value of `localizedMessage`. Subsequent reads from it will return its default value.
    public mutating func clearLocalizedMessage() {self._localizedMessage = nil}
